...
const AnnouncementBanner: React.FC = () => {
  return (
    <Link href="https://web.miniextensions.com/Zliw55HfhOWXZnca7Q9Q">
      <div className="w-full bg-navy border-b border-white/5 py-2 sm:py-1 px-4 z-50 relative hover:cursor-pointer hover:bg-navy-2 transition-all duration-300 animate-fade-up">
