...
const FooterV2: React.FC = () => (
  <footer className="px-4 sm:px-6 lg:px-12 py-3 flex flex-col sm:flex-row justify-between items-center gap-3 border-t border-white/[0.05]">
    <Reveal offset="sm">
      <Image
        ...
        width={160}
        height={20}
        className="h-[20px] w-auto opacity-35 hover:opacity-70 transition-opacity duration-500 ease-8vc"
      />
    </Reveal>
    <Reveal delay={100} offset="sm">
      <div className="flex gap-5 flex-wrap justify-center items-center">
        <Link href="/#about" className="text-white/25 text-[0.78rem] sm:text-[0.74rem] tracking-wide hover:text-white transition-colors duration-200 ease-8vc">
          About
        </Link>
        <Link href="/cohort" className="text-white/25 text-[0.78rem] sm:text-[0.74rem] tracking-wide hover:text-white transition-colors duration-200 ease-8vc">
          Cohort
        </Link>
        <Link href="/team" className="text-white/25 text-[0.78rem] sm:text-[0.74rem] tracking-wide hover:text-white transition-colors duration-200 ease-8vc">
          Team
        </Link>
        <Link href="/cookies" className="text-white/25 text-[0.78rem] sm:text-[0.74rem] tracking-wide hover:text-white transition-colors duration-200 ease-8vc">
          Cookies
        </Link>
